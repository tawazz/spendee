...
<link href="{{ baseUrl() }}/css/select2.bs.css" rel="stylesheet">
<link href="{{ baseUrl() }}/css/select2.min.css" rel="stylesheet" />
<link rel="stylesheet" type="text/css" href="{{ baseUrl() }}/css/bootstrap-material-design.css">
<link rel="stylesheet" type="text/css" href="{{ baseUrl() }}/css/tether.css">
<!-- Custom CSS -->
